...
def freq_to_round(f2hz):
  if f2hz <16.835 and f2hz >15.865: return 16.0
  if f2hz <17.835 and f2hz >16.805: return 17.2
  if f2hz <18.9 and f2hz >17.8: return 18.3
  if f2hz <20.025 and f2hz >18.875: return 19.0
  if f2hz <21.215 and f2hz >19.985: return 20.5
  if f2hz <22.475 and f2hz >21.185: return 21.7
  if f2hz <23.81 and f2hz >22.43: return 22.1
  if f2hz <25.23 and f2hz >23.77: return 24.0
  if f2hz <26.73 and f2hz >25.19: return 26.0
  if f2hz <28.32 and f2hz >26.68: return 27.0
  if f2hz <30.005 and f2hz >28.275: return 29.0
  if f2hz <31.785 and f2hz >29.955: return 30.7
  if f2hz <33.675 and f2hz >31.725: return 32.5
  if f2hz <35.68 and f2hz >33.62: return 34.0
  if f2hz <37.8 and f2hz >35.62: return 36.3
  if f2hz <40.045 and f2hz >37.735: return 38.8
  if f2hz <42.425 and f2hz >39.975: return 41.2
  if f2hz <44.95 and f2hz >42.35: return 43.5
  if f2hz <47.625 and f2hz >44.875: return 46.0
  if f2hz <50.455 and f2hz >47.545: return 49.0
  if f2hz <53.455 and f2hz >50.365: return 52.0
  if f2hz <56.635 and f2hz >53.365: return 55.0
  if f2hz <60.005 and f2hz >56.535: return 58.5
  if f2hz <63.575 and f2hz >59.905: return 62.0
  if f2hz <67.355 and f2hz >63.465: return 65.0
